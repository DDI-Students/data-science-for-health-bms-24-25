...
The exercise authors provided you with `hb14-hb19.csv`, which gives you the names of health boards. Join it with your dataset that you created for admissions and deaths and make use of it. Here are some examples of what you could do:
